...
TabNonSelected:
  ...
  STR     R4, [SP,#0x20+@Yout]
  MOV     R1, #77
  STR     R1, [SP,#0x20+@Width]
  MOV     R1, #20

SetTab:
  STR     R1, [SP,#0x20+@Height]
...
; # HP image (0/0): [77, 19] -> [91, 28]
  ...
  STR     R5, [SP,#0x20+@Yout]
  MOV     R4, #14
  STR     R4, [SP,#0x20+@Width]
  MOV     R0, #9
  STR     R0, [SP,#0x20+@Height]
  MOV     R0, #7
  STR     R0, [SP,#0x20+@Palette]
  LDR     R0, [R10,#0x60]
  MOV     R2, R1
...
; # Sword icon (0/0): [0, 0] -> [16, 16]
  ...
  STR     R5, [SP,#0x20+@Xout]
  STR     R5, [SP,#0x20+@Yout]
  STR     R6, [SP,#0x20+@Width]
  STR     R6, [SP,#0x20+@Height]
  MOV     R0, #5
  STR     R0, [SP,#0x20+@Palette]
  LDR     R0, [R10,#0x68]
  MOV     R2, R1
